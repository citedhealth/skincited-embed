...
[![npm](https://img.shields.io/npm/v/skincited-embed)](https://www.npmjs.com/package/skincited-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/skincited-embed)
[![Size](https://img.shields.io/badge/size-~8KB-green)](https://bundlephobia.com/package/skincited-embed)

Embed evidence-based health widgets for **Skin Health** on any website. **Zero dependencies**, Shadow DOM style isolation, 3 built-in themes (light, dark, clinical), and peer-reviewed research data from the [SkinCited](https://skincited.com) database.
...
> **Try the interactive widget builder at [widget.skincited.com](https://widget.skincited.com)**
...
Visit [skincited.com](https://skincited.com) — SkinCited is a comprehensive evidence-based health reference with peer-reviewed research, supplement profiles, and clinical condition summaries.

- **API docs**: [skincited.com/developers/](https://skincited.com/developers/)
- **Widget builder**: [widget.skincited.com](https://widget.skincited.com)
- **npm package**: [npmjs.com/package/skincited-embed](https://www.npmjs.com/package/skincited-embed)
...
Embed [SkinCited](https://skincited.com) widgets on any website with [skincited-embed](https://widget.skincited.com):

```html
<script src="https://cdn.jsdelivr.net/npm/skincited-embed@1/dist/embed.min.js"></script>
<div data-skincited="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.skincited.com)
